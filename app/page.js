...
// --- TRANSLATIONS & DATA ---
const translations = { en: { appName: "Crop Doc", appDescription: "Select a crop to begin scanning.", scanButton: "SCAN PLANT LEAF", historyButton: "View Scan History", analyzing: "Analyzing your leaf...", status: "STATUS", diseased: "DISEASED", healthy: "HEALTHY", confidence: "CONFIDENCE", cause: "Cause", treatment: "Treatment", scanAnother: "Scan Another", scanHistory: "Scan History", noHistory: "Your saved scans will appear here.", back: "Back", loginTitle: "Welcome to Crop Doc", loginSub: "Sign in with Google to save your scan history.", loginButton: "Sign In with Google", saveButton: "Save to History", saved: "Saved!", storageFull: "Storage is full (10 scans max).", yourId: "Your User ID:", "Failed to save.": "Failed to save.", loginError: "Login failed. Please try again.", loggingIn: "Signing In...", selectCrop: "Select a Crop", healthyMessage: "Your plant appears to be healthy! Keep up the great work.", changeCrop: "Change Crop" }, hi: { appName: "क्रॉप डॉक्टर", appDescription: "स्कैनिंग शुरू करने के लिए एक फसल का चयन करें।", scanButton: "पत्ते को स्कैन करें", historyButton: "स्कैन इतिहास देखें", analyzing: "आपके पत्ते का विश्लेषण हो रहा है...", status: "स्थिति", diseased: "रोगग्रस्त", healthy: "स्वस्थ", confidence: "आत्मविश्वास", cause: "कारण", treatment: "इलाज", scanAnother: "दूसरा स्कैन करें", scanHistory: "स्कैन इतिहास", noHistory: "आपके सहेजे गए स्कैन यहां दिखाई देंगे।", back: "वापस", loginTitle: "क्रॉप डॉक्टर में आपका स्वागत है", loginSub: "अपना स्कैन इतिहास सहेजने के लिए Google से साइन इन करें।", loginButton: "Google से साइन इन करें", saveButton: "इतिहास में सहेजें", saved: "सहेज लिया!", storageFull: "स्टोरेज भर गया है (अधिकतम 10 स्कैन)।", yourId: "आपकी उपयोगकर्ता आईडी:", "Failed to save.": "सहेजने में विफल।", loginError: "लॉगिन विफल। कृपया पुन: प्रयास करें।", loggingIn: "साइन इन हो रहा है...", selectCrop: "एक फसल चुनें", healthyMessage: "आपका पौधा स्वस्थ दिख रहा है! अच्छा काम करते रहें।", changeCrop: "फसल बदलें" }};

const dummyModelData = {
    tomato: {
        healthy: { status: 'Healthy', confidence: 0.98, diseaseName: null, cause: null, treatment: null },
        diseased: { status: 'Diseased', confidence: 0.92, diseaseName: 'Tomato Late Blight', cause: 'Caused by the fungus-like organism Phytophthora infestans.', treatment: 'Apply fungicides containing mancozeb, chlorothalonil, or copper-based compounds. Remove and destroy infected plants.' }
    },
    potato: {
        healthy: { status: 'Healthy', confidence: 0.99, diseaseName: null, cause: null, treatment: null },
        diseased: { status: 'Diseased', confidence: 0.88, diseaseName: 'Potato Early Blight', cause: 'Caused by the fungus Alternaria solani.', treatment: 'Practice crop rotation, use resistant varieties, and apply appropriate fungicides when necessary.' }
    },
    corn: {
        healthy: { status: 'Healthy', confidence: 0.97, diseaseName: null, cause: null, treatment: null },
        diseased: { status: 'Diseased', confidence: 0.95, diseaseName: 'Corn Common Rust', cause: 'Caused by the fungus Puccinia sorghi.', treatment: 'Most modern corn hybrids have good resistance. Fungicides are typically only needed in severe cases on susceptible varieties.' }
    },
    others: {
        healthy: { status: 'Healthy', confidence: 0.96, diseaseName: null, cause: null, treatment: null },
        diseased: { status: 'Diseased', confidence: 0.85, diseaseName: 'Generic Leaf Spot', cause: 'Caused by various fungi or bacteria. Common in humid conditions.', treatment: 'Ensure good air circulation, remove affected leaves, and use a general-purpose fungicide if necessary.' }
    }
};
...
export default function HomePage() {
  ...
  const handleImageChange = async (event) => {
    ...
    setTimeout(() => {
      const mockResult = Math.random() > 0.3 ? dummyModelData[state.selectedCategory].diseased : dummyModelData[state.selectedCategory].healthy;
  ...
  const renderContent = () => {
    switch (state.status) {
      ...
      case 'category_selection': return <CategorySelectionScreen onSelectCategory={handleSelectCategory} t={t} />;
